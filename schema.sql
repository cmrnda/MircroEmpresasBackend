...
(
    ...
    foreign key (empresa_id, usuario_id) references usuario (empresa_id, usuario_id) on delete cascade
);
...
(
    ...
    foreign key (empresa_id, producto_id) references producto (empresa_id, producto_id),
    foreign key (empresa_id, realizado_por_usuario_id) references usuario (empresa_id, usuario_id)
);
